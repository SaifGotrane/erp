...
class Sale extends Equatable {
  ...
  factory Sale.fromMap(Map<String, dynamic> map) => Sale(
    ...
    subInvoicesCount: (map['sale_sub_invoices'] as List?)?.isNotEmpty == true
        ? ((map['sale_sub_invoices'] as List).first as Map<String, dynamic>)['count'] as int? ?? 0
        : 0,
    lines:
