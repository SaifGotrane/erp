...
class EmployeeRepository extends BaseRepository {
  ...
  static List<String> _actionsForModule(String module) {
    switch (module) {
      ...
      case PermissionModule.subClients:
        return [PermissionAction.view, PermissionAction.create, PermissionAction.edit, PermissionAction.delete];
      ...
      case PermissionModule.invoicesSales:
      case PermissionModule.invoicesPurchases:
        return [PermissionAction.view, PermissionAction.print, PermissionAction.export];
      case PermissionModule.declarations:
        return [PermissionAction.view, PermissionAction.export];
      default:
        return [
          PermissionAction.view,
