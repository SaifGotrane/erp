...
class Employee extends Equatable {
  ...
  factory Employee.fromMap(Map<String, dynamic> map) {
    return Employee(
      ...
      isHouseholdHead: map['is_household_head'] as bool? ?? false,
      cnssNumber: map['cnss_number'] as String?,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'cnss_number': cnssNumber?.isEmpty == true ? null : cnssNumber,
    };
  }

  @override
  List<Object?> get props => [id, fullName, email, phone, role, active, depotId, showroomId, baseSalary, childrenCount, isHouseholdHead, cnssNumber];
}
