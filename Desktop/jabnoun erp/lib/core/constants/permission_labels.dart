...
class PermissionLabels {
  ...
  static const Map<String, String> modules = {
    ...
    PermissionModule.subClients: 'Sous-clients',
    ...
    PermissionModule.payroll: 'Fiches de paie',
    PermissionModule.invoicesSales: 'Factures ventes',
    PermissionModule.invoicesPurchases: 'Factures achats',
    PermissionModule.declarations: 'Déclarations mensuelles',
  };
