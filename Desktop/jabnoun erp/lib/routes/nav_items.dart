...
const List<NavSection> appNavSections = [
  ...
  NavSection(title: 'PARTENAIRES', items: [
    ...
    NavItem(label: 'Sous-clients', route: '/sub-clients', icon: Icons.person_outline, permissionModule: 'sub_clients'),
  ]),
  NavSection(title: 'ACHATS', items: [
    ...
    NavItem(label: 'Factures', route: '/invoices/purchases', icon: Icons.receipt_outlined, permissionModule: 'invoices_purchases'),
  ...
  NavSection(title: 'VENTES', items: [
    ...
    NavItem(label: 'Factures', route: '/invoices/sales', icon: Icons.receipt_outlined, permissionModule: 'invoices_sales'),
  ...
  NavSection(title: 'STOCK', items: [
    ...
    NavItem(label: 'Tableau de bord stock', route: '/stock-dashboard', icon: Icons.grid_view_outlined, permissionModule: 'stock'),
  ...
  NavSection(title: 'FINANCE', items: [
    ...
    NavItem(label: 'Déclaration mensuelle', route: '/declarations', icon: Icons.fact_check_outlined, permissionModule: 'declarations'),
  ...
  NavSection(title: 'ADMINISTRATION', items: [
    ...
    NavItem(label: 'Fiches de paie', route: '/payroll', icon: Icons.payments_outlined, permissionModule: 'payroll'),
